...
if __name__ == "__main__":
    ...
    if x == "1":
        # Input jpg file path
        image_path = input("Enter the path to your BMP image file ").strip()

        # Input secret message
        text = input("Enter the secret message you want to encode: ").strip() 

        # Encode the message
        encode_image(image_path, text)
    elif x == "2":
        # Input jpg file path for decoding
        image_path = input("Enter the path to the stego jpg image file ").strip()
